...
sudo podman build \
    ...
    -f Containerfile \
    -t ghcr.io/razorfinos/base:latest \
    .
```
...
```bash
# Build with date tag
sudo podman build -t ghcr.io/razorfinos/base:2025.10 .
sudo podman tag ghcr.io/razorfinos/base:2025.10 ghcr.io/razorfinos/base:latest
```
